...
const phantomAdp = {
    ...
    createPage: function() {
        ...
        .tap(page => {
            ...
            page.releaseOrClose = Promise.method(() => {
                // reset
                page.working = false;
                ...
                if(page.ttl <= 0) {
                    ...
                    // log
                    logger.info('Phantom.page.died', page.target);
                ...
                // 释放 page
                    ...
                    let releaseUrl = 'about:blank';
                    let releaseContent = '<html><body>Released</body></html>';

                    // release page mem
                    return page.setContent(releaseContent, releaseUrl);
                }
            });
        })
        // page debug info
