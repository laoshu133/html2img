...
const phantomAdp = {
    ...
    restartPhantom: function() {
        ...
        .then(() => {
            if(this.oldPhantom) {
                this.killPhantom(this.oldPhantom);
    ...
    getStatus: function() {
        ...
        .then(() => {
            ...
            lodash.assign(status.phantomStat, {
