    ...
    var tools = {
        ...
        listCovertors: {
            ...
            taobao: function(options) {
                ...
                var itemTpl = '<div class="{absClassName}" style="background:none;border:0;left:{left}px;top:{top}px;position:absolute"><a href="{href}" target="{target}" style="display:block;height:{height}px;width:{width}px"><img src="{imgBlank}" style="display:block;vertical-align:top" alt=""></a></div>';
