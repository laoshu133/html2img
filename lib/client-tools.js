    ...
    var tools = {
        ...
        listCovertors: {
            ...
            taobao: function(options) {
                var tpl = '<div class="{className}" style="line-height:1;height:{imgHeight}px"><table background="{imgUrl}" height="{imgHeight}" width="{imgWidth}" cellspacing="0" cellpadding="0" border="0"><tr><td valign="top" style="vertical-align:top"><div class="{absClassName}" style="left:auto;top:auto">{linkList}</div><img src="{imgUrl}" height="{imgHeight}" width="{imgWidth}" valign="top" alt=""></td></tr></table></div>';
