    ...
    var tools = {
        ...
        listCovertors: {
            ...
            taobao: function(options) {
                var tpl = '<div class="{className}" style="height:{imgHeight}px"><table background="{imgUrl}" height="{imgHeight}" width="{imgWidth}" cellspacing="0" cellpadding="0" border="0"><tr><td valign="top" style="vertical-align:top"><div class="{absClassName}" style="left:auto;top:auto">{linkList}</div></td></tr></table></div>';
                var itemTpl = '<div class="{absClassName}" style="display:inline;background:none;border:0;left:{left}px;top:{top}px"><a href="{href}" target="{target}" style="display:inline-block;height:{height}px;width:{width}px;vertical-align:top"><img src="{imgBlank}" height="{height}" width="{width}" valign="top"></a></div>';
