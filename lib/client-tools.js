    ...
    var tools = {
        ...
        listCovertors: {
            ...
            taobao: function(options) {
                var tpl = '<div class="{className}" style="height:{imgHeight}px"><table background="{imgUrl}" height="{imgHeight}" width="{imgWidth}" cellspacing="0" cellpadding="0" border="0"><tr><td valign="top" style="vertical-align:top"><div class="{absClassName}">{linkList}</div></td></tr></table></div>';
                var itemTpl = '<div class="{absClassName}" style="background:none;border:0;left:{left}px;top:{top}px;position:absolute"><a href="{href}" target="{target}" style="display:inline-block;height:{height}px;width:{width}px;vertical-align:top"><img src="{imgBlank}" style="display:inline-block;height:100%;vertical-align:top" alt=""></a></div>';
        ...
        getTaobaoAbsClass: function(shopType) {
            ...
            return 'most-footer footer-more-trigger sn-simple-logo';
        }
    };
