    ...
    var tools = {
        ...
        listCovertors: {
            ...
            taobao: function(options) {
                var tpl = '<div class="{className}" style="height:{imgHeight}px"><div class="{absClassName}">{linkList}</div><div><img src="{imgUrl}" width="{imgWidth}" height="{imgHeight}" border="0" style="vertical-align:top"></div></div>';
                var itemTpl = '<div class="{absClassName}" style="left:{left}px;top:{top}px;position:absolute"><a href="{href}" target="{target}" style="display:block;height:{height}px;width:{width}px"><img src="{imgBlank}" style="display:block;vertical-align:top" alt=""></a></div>';
