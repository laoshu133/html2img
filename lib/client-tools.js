    ...
    var tools = {
        ...
        listCovertors: {
            map: function(options) {
                var tpl = '<div class="{className}"><div><img usemap="#{mapName}" src="{imgUrl}" width="{imgWidth}" height="imgHeight" border="0"></div><map name="{mapName}" id="{mapName}">{linkList}</map></div>';
